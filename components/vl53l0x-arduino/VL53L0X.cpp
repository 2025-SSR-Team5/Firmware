...
#include "VL53L0X.h"
#include "../esp32-I2Cbus/I2Cbus.hpp"
//#include <Wire.h>
...
{
  last_status = writeByte(address, reg, value);
}
...
void VL53L0X::writeReg16Bit(uint8_t reg, uint16_t value)
{
  ...
  last_status = writeBytes(address, reg, 2, data);
}
...
void VL53L0X::writeReg32Bit(uint8_t reg, uint32_t value)
{
  ...
  last_status = writeBytes(address, reg, 4, data);
}
